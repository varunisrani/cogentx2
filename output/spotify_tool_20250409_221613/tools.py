...
class SpotifyMCPMCPTool(SpotifyMCPTool)(SpotifyMCPTool)(SpotifyTool)(BaseTool):
    ...
    Attributes:
        ...
        base_url: Base URL for the Spotify MCP server.
        url: Full URL for the Spotify MCP server with authentication.
        auth_params: Authentication parameters for the Spotify MCP server.
        available_tools: Cache of available Spotify tools.
    """
