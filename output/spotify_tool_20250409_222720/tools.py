...
# Helper functions
    def __init__(self, client_id: Optional[str] = None, client_secret: Optional[str] = None, smithery_api_key: Optional[str] = None, log_level: str = "INFO"):
        super().__init__()
        load_dotenv()
        self.logger, self.log_file_path = self._setup_logging(log_level)
        ...
        if not self.client_id or not self.client_secret:
            ...
            raise ValueError("Spotify API credentials not found. Please set SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET environment variables or provide them as arguments.")
...
class SpotifyMCPMCPTool(SpotifyMCPTool)(SpotifyMCPTool)(SpotifyTool)(BaseTool):
    """
    Tool for interacting with Spotify API using MCP through Smithery.
