...
class SpotifyMCPMCPTool(SpotifyMCPTool)(SpotifyMCPTool)(SpotifyTool)(BaseTool):
    """
    Spotify MCP client for interacting with the Spotify API through Smithery.
    
    This client provides a direct interface to Spotify API operations available 
    through the MCP (Model Context Protocol) system on Smithery.
