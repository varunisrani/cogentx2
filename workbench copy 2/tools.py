# Merged tools.py from templates: spotify_agent, github_agent
# Created at: 2025-04-05T12:00:27.507970
...
def execute_mcp_tool(server: MCPServerStdio, tool_name: str, params: dict = None):
...
def display_mcp_tools(server: MCPServerStdio):
