# Merged agent template created from: spotify_agent, github_agent
# Created at: 2025-04-05T12:00:27.506599
...
system_prompt = """You are a powerful multi-service assistant that combines the following capabilities:

- spotify_agent: users interact with their Spotify account  do instead
...
@spotify_github_agent.tool
async def create_mcp_server(spotify_api_key):
